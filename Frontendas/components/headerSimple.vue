    ...
    <div class="mx-auto max-w-7xl px-6">
      <div class="flex items-center justify-between border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        ...
        <PopoverGroup as="nav" class="hidden space-x-10 md:flex">
          ...
          <a href="http://localhost:3000/profile" class="text-base font-medium text-gray-500 hover:text-gray-900">Your profile</a>
        <a href="http://localhost:3000/threatList" class="text-base font-medium text-gray-500 hover:text-gray-900">Cybersecurity threats</a>
